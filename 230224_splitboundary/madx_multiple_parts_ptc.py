...
#madx.call('curvedcct.txt')
#madx.call('curvedcct_OGcopy.txt')
madx.call('Boundaries_split_multi_updated.madx')
...
with open("1403_1024_xtunes_new_1sig.txt","w") as external_file:
    print(*q_x_1024,sep='\n',file=external_file)
external_file.close()
with open("1403_1024_ytunes_new_1sig.txt","w") as external_file:
    print(*q_y_1024,sep='\n',file=external_file)
external_file.close()

with open("1403_2048_xtunes_new_1sig.txt","w") as external_file:
    print(*q_x_2048,sep='\n',file=external_file)
external_file.close()
with open("1403_2048_ytunes_new_1sig.txt","w") as external_file:
    print(*q_y_2048,sep='\n',file=external_file)
external_file.close()
...
with open("1403_jx_new_1sig.txt","w") as external_file:
    print(*Jx[:,0],sep='\n',file=external_file)
external_file.close()
with open("1403_jy_new_1sig.txt","w") as external_file:
    print(*Jy[:,0],sep='\n',file=external_file)
external_file.close()
