...
with open("2905_1024_xtunes_split_rem_multi_nat.txt","w") as external_file:
    print(*q_x_1024,sep='\n',file=external_file)
external_file.close()
with open("2905_1024_ytunes_split_rem_multi_nat.txt","w") as external_file:
    print(*q_y_1024,sep='\n',file=external_file)
external_file.close()

with open("2905_2048_xtunes_split_rem_multi_nat.txt","w") as external_file:
    print(*q_x_2048,sep='\n',file=external_file)
external_file.close()
with open("2905_2048_ytunes_split_rem_multi_nat.txt","w") as external_file:
    print(*q_y_2048,sep='\n',file=external_file)
external_file.close()
...
with open("2905_jx_split_rem_multi_nat.txt","w") as external_file:
    print(*Jx[:,0],sep='\n',file=external_file)
external_file.close()
with open("2905_jy_split_rem_multi_nat.txt","w") as external_file:
    print(*Jy[:,0],sep='\n',file=external_file)
external_file.close()
