...
with open("0807_1024_xtunes_corrected_moremulti_nat.txt","w") as external_file:
    print(*q_x_1024,sep='\n',file=external_file)
external_file.close()
with open("0807_1024_ytunes_corrected_moremulti_nat.txt","w") as external_file:
    print(*q_y_1024,sep='\n',file=external_file)
external_file.close()

with open("0807_2048_xtunes_corrected_moremulti_nat.txt","w") as external_file:
    print(*q_x_2048,sep='\n',file=external_file)
external_file.close()
with open("0807_2048_ytunes_corrected_moremulti_nat.txt","w") as external_file:
    print(*q_y_2048,sep='\n',file=external_file)
external_file.close()
...
with open("0807_jx_corrected_moremulti_nat.txt","w") as external_file:
    print(*Jx[:,0],sep='\n',file=external_file)
external_file.close()
with open("0807_jy_corrected_moremulti_nat.txt","w") as external_file:
    print(*Jy[:,0],sep='\n',file=external_file)
external_file.close()
