...
q_x_1024=list(np.loadtxt('2905_1024_xtunes_og_nat.txt'))
q_x_2048=list(np.loadtxt('2905_2048_xtunes_og_nat.txt'))
q_y_1024=list(np.loadtxt('2905_1024_ytunes_og_nat.txt'))
q_y_2048=list(np.loadtxt('2905_2048_ytunes_og_nat.txt'))
...
plt.ylabel('$q_y$')
plt.legend()
plt.savefig('290524_fma_og_nat.pdf')
...
plt.colorbar(label='D')
#plt.show()
plt.savefig('290524tunediff_og_nat.pdf')
