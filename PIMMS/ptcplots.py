...
q_x_1024_1=list(np.loadtxt('1705_1024_xtunes_splitmultipimms_10sig.txt'))
q_x_2048_1=list(np.loadtxt('1705_2048_xtunes_splitmultipimms_10sig.txt'))
q_y_1024_1=list(np.loadtxt('1705_1024_ytunes_splitmultipimms_10sig.txt'))
q_y_2048_1=list(np.loadtxt('1705_2048_ytunes_splitmultipimms_10sig.txt'))
"""
...
#plt.show()
plt.savefig('170524tunediff_splitmultipimms_10sig.pdf')
...
plt.colorbar(label='D')
#plt.show()
plt.savefig('170524fma_splitmultipimms_10sig.pdf')
