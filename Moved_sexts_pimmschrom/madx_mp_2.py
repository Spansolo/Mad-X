...
#madx.call('curvedcct_newvals.txt')
#madx.call('curvedcct_OGcopy.txt')
madx.call('Boundaries_split_matchedpimms_multiring.madx')
#madx.call('dilutedsext.madx')
...
madx_twiss = madx.twiss(sequence='TERARING', file='nimms_twiss.tfs')
#list(madx_twiss)
...
with open("1505_1024_xtunes_rematchedmulti_10sig.txt","w") as external_file:
    print(*q_x_1024,sep='\n',file=external_file)
external_file.close()
with open("1505_1024_ytunes_rematchedmulti_10sig.txt","w") as external_file:
    print(*q_y_1024,sep='\n',file=external_file)
external_file.close()

with open("1505_2048_xtunes_rematchedmulti_10sig.txt","w") as external_file:
    print(*q_x_2048,sep='\n',file=external_file)
external_file.close()
with open("1505_2048_ytunes_rematchedmulti_10sig.txt","w") as external_file:
    print(*q_y_2048,sep='\n',file=external_file)
external_file.close()
...
with open("1505_jx_rematchedmulti_10sig.txt","w") as external_file:
    print(*Jx[:,0],sep='\n',file=external_file)
external_file.close()
with open("1505_jy_rematchedmulti_10sig.txt","w") as external_file:
    print(*Jy[:,0],sep='\n',file=external_file)
external_file.close()
