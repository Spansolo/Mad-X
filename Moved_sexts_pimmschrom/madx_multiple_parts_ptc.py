...
madx.call('curvedcct_newvals_movedsexts.txt')
...
with open("1505_1024_xtunes_ogmulti_10sig.txt","w") as external_file:
    print(*q_x_1024,sep='\n',file=external_file)
external_file.close()
with open("1505_1024_ytunes_ogmulti_10sig.txt","w") as external_file:
    print(*q_y_1024,sep='\n',file=external_file)
external_file.close()

with open("1505_2048_xtunes_ogmulti_10sig.txt","w") as external_file:
    print(*q_x_2048,sep='\n',file=external_file)
external_file.close()
with open("1505_2048_ytunes_ogmulti_10sig.txt","w") as external_file:
    print(*q_y_2048,sep='\n',file=external_file)
external_file.close()
...
with open("1505_jx_ogmulti_10sig.txt","w") as external_file:
    print(*Jx[:,0],sep='\n',file=external_file)
external_file.close()
with open("1505_jy_ogmulti_10sig.txt","w") as external_file:
    print(*Jy[:,0],sep='\n',file=external_file)
external_file.close()
