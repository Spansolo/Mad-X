...
madx.call('Multiring_unrematched.madx')
...
with open("1505_1024_xtunes_unrematchedmulti_10sig.txt","w") as external_file:
    print(*q_x_1024,sep='\n',file=external_file)
external_file.close()
with open("1505_1024_ytunes_unrematchedmulti_10sig.txt","w") as external_file:
    print(*q_y_1024,sep='\n',file=external_file)
external_file.close()

with open("1505_2048_xtunes_unrematchedmulti_10sig.txt","w") as external_file:
    print(*q_x_2048,sep='\n',file=external_file)
external_file.close()
with open("1505_2048_ytunes_unrematchedmulti_10sig.txt","w") as external_file:
    print(*q_y_2048,sep='\n',file=external_file)
external_file.close()
...
with open("1505_jx_unrematchedmulti_10sig.txt","w") as external_file:
    print(*Jx[:,0],sep='\n',file=external_file)
external_file.close()
with open("1505_jy_unrematchedmulti_10sig.txt","w") as external_file:
    print(*Jy[:,0],sep='\n',file=external_file)
external_file.close()
