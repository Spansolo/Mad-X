...
foo = np.reshape(lostparts,(len(sp_4),np.size(X)))
...
with open("120624_4thhalf_survived_30_natchrom.txt","w") as external_file:
    print(*boo,sep='\n',file=external_file)
external_file.close()
