...
foo = np.reshape(lostparts,(len(sp_2),np.size(X)))
...
with open("120624_2ndhalf_survived_30_natchrom.txt","w") as external_file:
    print(*boo,sep='\n',file=external_file)
external_file.close()
